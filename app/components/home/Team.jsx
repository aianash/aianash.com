      ...
      <div className={cx("container")}>
        ...
        <div className={cx("col-md-4")}>
          <div className={cx("person")}>
            ...
            <h3>Kumar Ishan</h3>
            <h4>Founder</h4>
            <p>Versatile Developer. Deep into Machine Learning. Life Long Learner. Bibliophile. IIT Roorkee. Ex-Amazonian.</p>
        ...
        <div className={cx("col-md-4")}>
          <div className={cx("person")}>
            ...
            <h3>Gaurav Gupta</h3>
            <h4>Co-Founder</h4>
            <p>Tech enthusiast. AI researcher. Android addict. Movie buff. Love puzzles. IIT Roorkee. Ex-Oraclite.</p>
            <ul className={cx("social")}>
