  ...
  return (
    <div id="aian-portfolio-section">
      <div className={cx("portfolio-row-half")}>
        ...
        <a href="#" className={cx("portfolio-grid-item", "aianash")} style={ec}>
        ...
        <a href="#" className={cx("portfolio-grid-item", "aianash")} style={sr}>
          <div className={cx("desc2")}>
            <h3>Web Services</h3>
        ...
        <a href="#" className={cx("portfolio-grid-item", "aianash")} style={pd}>
          <div className={cx("desc2")}>
            <h3>Product</h3>
